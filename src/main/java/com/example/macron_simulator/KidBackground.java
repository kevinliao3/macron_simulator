...
public class KidBackground extends DialogueScene {

    public KidBackground(double X, double Y, String passedDialogue) {
        super(passedDialogue);

        Image x = new Image("file:assets/will.png",X,Y, true,true);
